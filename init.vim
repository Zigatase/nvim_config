...
Plug 'https://github.com/terryma/vim-multiple-cursors' " CTRL + N for multiple cursorsset encoding=UTF-8
Plug 'https://github.com/gregsexton/MatchTag' "This plugin highlights the matching HTML tagsd
